...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'kjm@kninetails.onmicrosoft.com',
  ...
  title: "Kyle's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/OnedriveVercel',
  ...
  protectedRoutes: ['/💻 Computer Files/🎮 Game Files/🧟 PvZ, 
                    '/🔗 For Sharing/📸 Photos/Test'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:kjmcabangon@slsu.edu.ph',
